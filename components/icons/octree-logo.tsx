...
export function OctreeWordmark({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        spaceGrotesk.className,
        'font-medium tracking-[-0.02em] text-neutral-900',
        className
      )}
    >
      octree
...
export function OctreeLogo({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="96" height="96" rx="22" fill="url(#octree_tile)" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
